...
public final class Config {
    ...
    public Config(ConfigData data) {
        ...
        this.tooLongText = PARSER.parseComponent(data.tooLongMessage, ParserContext.of());
        this.nicknameCantContainSpacesText = PARSER.parseComponent(data.nicknameCantContainSpacesMessage, ParserContext.of());
